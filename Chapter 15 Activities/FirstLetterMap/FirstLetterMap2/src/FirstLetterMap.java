...
public class FirstLetterMap
{
    public static void main(String[] args)
    {
        ...
        try (Scanner in = new Scanner(new File(filename)))
        {
            ...
            Map<Character, Set<String>> firstLetters = new HashMap<>();
            ...
            while (in.hasNext())
            {
                ...
                if (firstLetters.get(c) == null) {
                    ...
                    current.add(word);
                    firstLetters.put(c, current);
                } else {
                    Set<String> current = firstLetters.get(c);
                    current.add(word);
                    firstLetters.put(c, current);
                }
            ...
            // a: [a, able, aardvark]
            for (Character c : firstLetters.keySet()) {
                System.out.println(c + ": " + firstLetters.get(c));
            }
